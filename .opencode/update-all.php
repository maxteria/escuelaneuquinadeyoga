...
<div style="background:#fff;padding:80px 20px;">
    <div style="max-width:1200px;margin:0 auto;display:grid;grid-template-columns:repeat(3,1fr);gap:40px;">
        <div>
            ...
            <p style="font-family:Raleway;font-size:16px;color:#5C4F43;line-height:1.6;">Programas estructurados de formación en yoga. Cursos progresivos que acompañamiento tu desarrollo como practitioner e instructor.</p>
        </div>
        <div>
...
';
wp_update_post(array('ID'=>1483,'post_content'=>$inicio));
echo "Inicio updated\n";
...
';
wp_update_post(array('ID'=>1491,'post_content'=>$tradicion));
echo "Tradición updated\n";

// Instructora (1493)
$instructora = '
<div style="background:#faf7f4;padding:80px 20px;">
    <div style="max-width:1000px;margin:0 auto;display:grid;grid-template-columns:280px 1fr;gap:50px;align-items:center;text-align:left;">
        <div>
            <img src="https://escuelaneuquinadeyoga.local/wp-content/uploads/2022/03/About-2-scaled-1-342x1024.jpeg" alt="Instructora" style="width:100%;max-width:280px;border-radius:8px;">
        </div>
        <div>
            <h1 style="font-family:Gilda Display;font-size:42px;color:#3D3229;margin-bottom:15px;">La instructora</h1>
            <p style="font-family:Raleway;font-size:18px;color:#5C4F43;line-height:1.8;margin-bottom:20px;">Formada en la tradición del yoga clásico, acompaña a estudiantes desde hace más de 15 años en su camino de práctica y estudio. Su enfoque combina la tradición yóganica con una comprensión profunda del cuerpo y la respiración.</p>
...
';
wp_update_post(array('ID'=>1493,'post_content'=>$instructora));
echo "Instructora updated\n";
...
';
wp_update_post(array('ID'=>1492,'post_content'=>$escuela));
echo "La Escuela updated\n";
echo "\nDone!";